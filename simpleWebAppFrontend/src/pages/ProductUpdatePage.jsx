...
import { base64ToFile } from '../utils/fileConversion';
        ...
        async function fetchProduct(){
         try {
            ...
            if(response.ok){
                ...
                const file = base64ToFile(data.imageData, data.imageType, data.imageName);
                setImage(file)
            }
        } catch (error) {
            console.log(error.message);
    ...
    <div>
        ...
        <div style={{
         ...
         <div style={{
          ...
          <input type="checkbox" name="available" id="available" checked={product.available} onChange={(e) => setProduct({...product, available: e.target.checked})} />
...
export default CommonLayout()(ProductUpdatePage)